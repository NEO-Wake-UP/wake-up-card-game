...
**Правила утверждены автором:** русский текст совпадает с [одностраничным PDF A5](print-and-play/ru/WAKE_UP_rules_RU_A5.pdf). [Английские правила](game/en/rules.md) переведены с этой же редакции; независимая языковая вычитка ещё впереди. Первая вычитка русских событий завершена; статусы ST-001–032 утверждены, формулировка «Джокера» обсуждается. Английский каталог ждёт перевода. Полных готовых наборов для печати пока нет.
