...
- The game materials use standard [CC BY-SA 4.0](LICENSE.md): preserve attribution, indicate modifications and follow ShareAlike when sharing adaptations. Read the [English explanation](legal/license.en.md). [Publishing suggestions](legal/publishing-guide.md) are voluntary; no extra price, approval or reporting rules apply. / Материалы игры — по стандартной CC BY-SA 4.0: сохраняйте авторство, обозначайте изменения и соблюдайте ShareAlike при распространении переработок. Пожелания издателям добровольны; дополнительных требований к цене, согласованию и отчётности нет.
